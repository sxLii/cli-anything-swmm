...
Usage:
    ...
    skin = ReplSkin("shotcut", version="1.1.0")
...
_ACCENT_COLORS = {
    ...
    "swmm":        "\033[38;5;45m",    # water blue (EPA SWMM)
}
...
class ReplSkin:
    ...
    def __init__(self, software: str, version: str = "1.1.0",
...
_ANSI_256_TO_HEX = {
    ...
    "\033[38;5;45m":  "#00d7ff",  # swmm water blue
